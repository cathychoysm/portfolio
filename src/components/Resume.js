  ...
  const technologiesItems = technologies.map((technology) => {
    return (
      <ListItem key={technology.name} fontSize="clamp(12px, 1.5vw, 20px)">
        <HStack>
          <Center
            width="clamp(15px, 0.1vw, 20px)"
            height="clamp(15px, 0.1vw, 20px)"
            paddingRight="10px"
          >
    ...
    >
      ...
      >
        ...
        <VStack gridArea={"employment-education"} gap="3vh">
          ...
          >
            <CardHeader>
              <Heading fontSize="clamp(15px, 2vw, 23px)">
                Employment History
              </Heading>
            </CardHeader>
            <CardBody>
              <List spacing="50px">{employmentItems}</List>
            </CardBody>
          </Card>
          <Card
            alignSelf="flex-start"
          ...
          >
            ...
            <CardBody>
              <Text fontSize="clamp(12px, 1.5vw, 20px)" fontWeight={600}>
                {education.subject}
              </Text>
              <Text
        ...
        >
          ...
          <CardBody>
            <List spacing="2vh">{certItems}</List>
          </CardBody>
        </Card>
      </Grid>
    </VStack>
