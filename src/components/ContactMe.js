  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string()
        ...
        .required("Let me know your email so that I can get back to you"),
      message: Yup.string()
        .max(200, "Please make it shorter than 200 words")
  ...
  return (
    ...
    >
      ...
      <VStack
        ...
        bgColor="purple.100"
        shadow="inset 1px 1px 5px white, 5px 5px 5px #866986"
      ...
      >
        ...
        >
          ...
          >
            <FormLabel htmlFor="name" fontSize="clamp(13px, 1.8vw, 20px)">
              Name:
            </FormLabel>
            <Input
              id="name"
            ...
            />
            <FormErrorMessage fontSize="clamp(9px, 1.3vw, 12px)">
              {formik.errors.name}
            </FormErrorMessage>
          </FormControl>
          <FormControl
          ...
          >
            <FormLabel htmlFor="email" fontSize="clamp(13px, 1.8vw, 20px)">
              Email:
            </FormLabel>
            <Input
              id="email"
          ...
          >
            <FormLabel htmlFor="message" fontSize="clamp(13px, 1.8vw, 20px)">
              Message:
            </FormLabel>
            <Textarea
              id="message"
